<?php namespace App\Http\Controllers;
	...
	class AdminNotesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"ملف مرفق","name"=>"screen"];
	...
	//		$this->form[] = ['label'=>'صاحب الملاحظة','name'=>'cms_users_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name'];
			$this->form[] = ['label'=>'الموضوع','name'=>'subject','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'ملف مرفق','name'=>'screen','type'=>'upload'];
