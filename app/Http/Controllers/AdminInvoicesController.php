<?php namespace App\Http\Controllers;
	...
	class AdminInvoicesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"قيمة الفاتورة","name"=>"amount"];
			$this->col[] = ["label"=>"العقد","name"=>"contracts_id","join"=>"contracts,id"];
			$this->col[] = ["label"=>"رقم الفاتورة","name"=>"InvoiceId"];
			$this->col[] = ["label"=>"حالة الفاتورة","name"=>"paid"];
			$this->col[] = ["label"=>"تاريخ الفوترة","name"=>"created_at"];
			$this->col[] = ["label"=>"تاريخ السداد","name"=>"updated_at"];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'غير مدفوع',
			'icon'=>'fa fa-ban',
			'color'=>'warning',
			'showIf'=>"[paid] == '0'"
			];
			$this->addaction[] = ['label'=>'مدفوع',
			'icon'=>'fa fa-money',
			'color'=>'primary',
			'showIf'=>"[paid] == '1'"
			];
