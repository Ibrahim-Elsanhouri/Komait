<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers18Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'الملفات المدعومة : JPG, JPEG, PNG, GIF, BMP'];
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:cms_users','width'=>'col-sm-10','placeholder'=>'صيغة البريد الإلكتروني غير صحيحة'];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'تفعيل العميل','url'=>CRUDBooster::mainpath('set-status/1/[id]'),'icon'=>'fa fa-check','color'=>'success','showIf'=>"[verified] == '0'"];
			$this->addaction[] = ['label'=>'حظر العميل','url'=>CRUDBooster::mainpath('set-status/0/[id]'),'icon'=>'fa fa-ban','color'=>'warning','showIf'=>"[verified] == '1'", 'confirmation' => true];
	    ...
	    */
		...
		public function getSetStatus($status,$id) {
			DB::table('cms_users')->where('id',$id)->update(['verified'=>$status]);
