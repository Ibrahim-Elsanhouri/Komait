<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers30Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"الجوال","name"=>"mobile","image"=>true];
			...
			$this->form[] = ['label'=>'الصورة','name'=>'photo','type'=>'upload','validation'=>'|image|max:3000','width'=>'col-sm-10','help'=>'الملفات المدعومة : JPG, JPEG, PNG, GIF, BMP'];
			$this->form[] = ['label'=>'الايميل','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:cms_users','width'=>'col-sm-10','placeholder'=>'صيغة البريد الإلكتروني غير صحيحة'];
