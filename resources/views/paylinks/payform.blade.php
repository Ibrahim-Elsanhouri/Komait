                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item">
                            <h2اتمام الدفع</h2>
                            <p>{{ $offer->consultant->name }}<span>/<span>الدفع</p>
                        </div>
                    </div>
                </div>
            </div>
...
<table class="table" style="direction:rtl;">
  <thead>
    <tr>
      <th scope="col">
          <div class="text-center">رقم العرض</div>

      
       </th>
      <th scope="col">          <div class="text-center">{{ $offer->id }}</div>
</th>
     ...
     <tr>
      ...
      <th scope="col">          <div class="text-center">{{ $offer->cost }}</div>
</th>
  ...
  <tbody>
      ...
      <form method="post" action="{{ route('paylink.invoice') }}">
      @csrf
<input type="hidden" value="{{ $offer->cost }}" name="cost"/>
